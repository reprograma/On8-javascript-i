...
botaoCalcular.addEventListener('click', function (event) {
    ...
    if (mediaFinal >= 7 && mediaFinal <= 10) {
        mensagem.textContent = 'UHUUUL Parabéns, Você foi aprovado! Sua média é '+ (mediaFinal);
    ...
    if (isNaN (nota1) || isNaN(nota2)) {
        mensagem.textContent = 'Por favor, preencha corretamente os campos com valores numéricos entre 0 e 10';
    ...
    if (nota1 < 0 || nota1 > 10 || nota2 < 0 || nota2 > 10) {
        mensagem.textContent = 'Por favor, preencha os campos com valores entre 0 e 10'
        mensagem.classList.add('mensagem-de-erro')
    }
});
